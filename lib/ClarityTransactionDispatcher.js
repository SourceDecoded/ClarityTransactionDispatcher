        ...
        */
        ...
        value: function addEntityAsync(entity) {
            ...
            return this._notifySystemsWithRecoveryAsync("prepareEntityToBeAddedAsync", [newEntity]).then(function () {
                _this7.validateEntityToBeAddedAsync(newEntity);
            }).then(function () {
        ...
        */
        ...
        value: function stopAsync() {
            ...
            return this._notifySystemsWithRecoveryAsync("deactivatedAsync", []).then(function () {
                return _this14.mongoDb.stopAsync();
            });
        }
        ...
        value: function updateEntityAsync(entity) {
            ...
            return this._findOneAsync(ENTITIES_COLLECTION, {
                ...
                return _this15._notifySystemsWithRecoveryAsync("prepareEntityToBeUpdatedAsync", [oldEntity, updatedEntity]).then(function () {
                    return _this15.validateEntityToBeUpdatedAsync(updatedEntity);
                }).then(function () {
                    return oldEntity;
                });
            }).then(function (oldEntity) {
                ...
                updatedEntity.revision = _this15.ObjectID();
                updatedEntity.createdDate = oldEntity.createdDate;

                return _this15._updateItemInCollectionAsync(ENTITIES_COLLECTION, updatedEntity).then(function (oldEntity) {
                    return _this15._notifySystemsWithRecoveryAsync("entityUpdatedAsync", [oldEntity, Object.freeze(updatedEntity)]);
                }).then(function () {
                    return updatedEntity;
                });
            }).catch(function (error) {
                _this15.logError(error);
                throw error;
            });
        }
