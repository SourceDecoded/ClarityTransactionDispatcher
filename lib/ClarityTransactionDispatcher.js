        ...
        */
        ...
        value: function startAsync() {
            ...
            if (this.startedPromise == null) {
                ...
                return this.startedPromise = stoppedPromise.then(function () {
                    _this13._notifySystemsWithRecoveryAsync("activatedAsync", [_this13]);
                }).then(function () {
                    _this13.isInitialized = true;
                });
            } else {
        ...
        value: function stopAsync() {
            ...
            if (this.stoppedPromise == null) {
                ...
                return this.stoppedPromise = startedPromise.then(function () {
                    return _this14._notifySystemsWithRecoveryAsync("deactivatedAsync", []);
                }).then(function () {
                    _this14.isInitialized = false;
                });
            } else {
        ...
        value: function updateEntityAsync(entity) {
            ...
            updatedEntity.components.forEach(function (component) {
                if (!component._id) {
                    component._id = _this15.ObjectID();
                } else {
                    component._id = _this15.ObjectID(component._id);
                }
            });
            ...
            return this._findOneAsync(ENTITIES_COLLECTION, {
                ...
                return _this15._notifySystemsWithRecoveryAsync("prepareEntityToBeUpdatedAsync", [oldEntity, updatedEntity]);
            }).then(function () {
                return _this15.validateEntityToBeUpdatedAsync(oldEntity, updatedEntity);
            }).then(function () {
                return _this15._updateItemInCollectionAsync(ENTITIES_COLLECTION, updatedEntity);
            }).then(function () {
                return _this15._notifySystemsWithRecoveryAsync("entityUpdatedAsync", [oldEntity, updatedEntity]);
            }).then(function () {
                return updatedEntity;
            }).catch(function (error) {
                _this15.logErrorAsync(error);
                throw error;
            });
        }
