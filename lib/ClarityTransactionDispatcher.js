...
var ClarityTransactionDispatcher = function () {
    ...
    _createClass(ClarityTransactionDispatcher, [{
        ...
        */
        ...
        key: "_invokeMethod",
        value: function _invokeMethod(obj, methodName, args) {
            var returnValue;
        ...
        key: "_notifySystems",
        value: function _notifySystems(method, args) {
            var _this3 = this;

            return this.systems.map(function (systems) {
                try {
                    return _this3._invokeMethod(systems, method, args);
                } catch (error) {
        ...
        value: function _notifySystemsWithRecoveryAsync(methodName, args) {
            ...
            return this.systems.reduce(function (promise, system) {
                ...
                return promise.then(function () {
                    ...
                    try {
                        return _this5._invokeMethodAsync(system, methodName, args);
                    } catch (error) {
        ...
        value: function addEntityAsync(entity) {
            ...
            return this._notifySystemsWithRecoveryAsync("prepareEntityToBeAddedAsync", [newEntity]).then(function () {
                _this8.validateEntityToBeAddedAsync(newEntity);
            }).then(function () {
                return _this8._addItemToCollectionAsync(ENTITIES_COLLECTION, newEntity);
            }).then(function (entity) {
                return _this8._notifySystemsWithRecoveryAsync("entityAddedAsync", [Object.freeze(entity)]).then(function () {
                    return entity;
                });
            }).catch(function (error) {
        ...
        value: function addSystemAsync(system) {
            ...
            if (!this.validateSystem(system)) {
                ...
                return this._initializingSystemAsync(system).then(function () {
                    ...
                    return _this9._invokeMethodAsync(system, "activatedAsync", [_this9]);
                }).then(function () {
                    _this9.logMessage({
                        type: NOTICE,
        ...
        */
        ...
        value: function disposeSystemAsync(system) {
            ...
            if (index === -1) {
                ...
                try {
                    return disposedPromise = this._invokeMethodAsync(system, "disposeAsync", []).then(function () {
                        _this11.logMessage({
                            type: NOTICE,
        ...
        value: function getEntitiesAsync(config) {
            ...
            return this._findAsync(ENTITIES_COLLECTION, filter, sort, pageSize).then(function (entities) {
                var notifySystemsPromises = entities.map(function (entity) {
                    return _this12._notifySystemsWithRecoveryAsync("entityRetrievedAsync", [entity]);
                });
        ...
        value: function getEntityByIdAsync(entityId) {
            ...
            return this._findOneAsync(ENTITIES_COLLECTION, {
                ...
                return _this13._notifySystemsWithRecoveryAsync("entityRetrievedAsync", [entity]).then(function () {
                    return entity;
                });
            }).catch(function (error) {
        ...
        value: function removeEntityAsync(entity) {
            ...
            return this.approveEntityToBeRemovedAsync(entity).then(function () {
                return _this14._removeItemfromCollection(ENTITIES_COLLECTION, entity);
            }).then(function () {
                return _this14._notifySystemsWithRecoveryAsync("entityRemovedAsync", [entity]);
            }).then(function () {
                return entity;
            }).catch(function (error) {
        ...
        value: function startAsync() {
            ...
            return this.mongoDb.startAsync().then(function () {
                _this15.isInitialized = true;
            });
        }
        ...
        value: function stopAsync() {
            ...
            return this._notifySystemsWithRecoveryAsync("deactivatedAsync", []).then(function () {
                return _this16.mongoDb.stopAsync();
            });
        }
        ...
        value: function updateEntityAsync(entity) {
            ...
            return this._findOneAsync(ENTITIES_COLLECTION, {
                ...
                return _this17._notifySystemsWithRecoveryAsync("prepareEntityToBeUpdatedAsync", [oldEntity, updatedEntity]).then(function () {
                    return _this17.validateEntityToBeUpdatedAsync(updatedEntity);
                }).then(function () {
                    return oldEntity;
                });
            }).then(function (oldEntity) {
                ...
                updatedEntity.revision = _this17.ObjectID();
                updatedEntity.createdDate = oldEntity.createdDate;

                return _this17._updateItemInCollectionAsync(ENTITIES_COLLECTION, updatedEntity).then(function (oldEntity) {
                    return _this17._notifySystemsWithRecoveryAsync("entityUpdatedAsync", [oldEntity, Object.freeze(updatedEntity)]);
                }).then(function () {
                    return updatedEntity;
                });
            }).catch(function (error) {
                _this17.logError(error);
                throw error;
            });
        }
        ...
        value: function validateEntityToBeUpdatedAsync(entity) {
